...
app.config['MONGO_URI']='mongodb+srv://marioca:marioca@cluster0.vgfodcs.mongodb.net/?retryWrites=true&w=majority'
client = MongoClient("mongodb+srv://marioca:marioca@cluster0.vgfodcs.mongodb.net/?retryWrites=true&w=majority")
